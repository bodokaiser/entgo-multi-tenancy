...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.TeamsCleared() {
		...
		createE := &MemberCreate{config: uu.config, mutation: newMemberMutation(uu.config, OpCreate)}
		createE.defaults()
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.TeamsCleared() {
		...
		createE := &MemberCreate{config: uuo.config, mutation: newMemberMutation(uuo.config, OpCreate)}
		createE.defaults()
		_, specE := createE.createSpec()
		edge.Target.Fields = specE.Fields
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
